 ...
 * both state and behavior, Lambda represents only the functionality.
 * Through this Java has achieved functional programming.
 * 
 * What is the return type of the lambda expression we have used?
 * Let's check the comments on ExecuteLambdaEnhancement1_1.java
 * 
 * @author Khan_sa
 *
 */
